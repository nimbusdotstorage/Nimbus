...
import type { Tag, FileTag } from "@/providers/google/types";
...
export class TagService {
	...
	// Create a new tag
	async createTag(userId: string, name: string, color: string, parentId?: string): Promise<Tag> {
	...
	async updateTag(
		tagId: string,
		userId: string,
		updates: { name?: string; color?: string; parentId?: string }
	): Promise<Tag> {
