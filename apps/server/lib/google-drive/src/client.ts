...
export interface ClientOptions {
	 ...
	 *
	 * Defaults to process.env['GOOGLEDRIVE_BASE_URL'].
	 */
	 ...
	 * Set the log level.
	 *
	 * Defaults to process.env['GOOGLEDRIVE_LOG'] or 'warn' if it isn't set.
	 */
...
export class GoogleDrive {
	...
	constructor({
		...
		this.logLevel =
			...
			parseLogLevel(readEnv("GOOGLEDRIVE_LOG"), "process.env['GOOGLEDRIVE_LOG']", this) ??
			defaultLogLevel;
	...
	changes: API.Changes = new API.Changes(this);
	channels: API.Channels = new API.Channels(this);
	drives: API.Drives = new API.Drives(this);
